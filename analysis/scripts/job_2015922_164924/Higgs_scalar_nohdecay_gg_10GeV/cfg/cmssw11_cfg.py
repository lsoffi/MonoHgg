...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring('/store/user/mzientek/RunIISpring15-50ns/Higgs_scalar/Higgs_scalar_nohdecay_gg_10GeV_13TeV_RunIISpring15-50ns-Spring15BetaV1_MetaV3-v0-RunIISpring15DR74-Asympt50ns_MCRUN2_74_V9A-v1/150819_131935/0000/myMicroAODOutputFile_1.root')
...
process.TFileService = cms.Service("TFileService",fileName = cms.string("Higgs_scalar_nohdecay_gg_10GeV_11.root"))
...
process.diPhoAna = cms.EDAnalyzer('DiPhoAnalyzer',
				  ...
				  bits	        = cms.InputTag('TriggerResults::HLT'),
                                  ...
                                  sumDataset = cms.untracked.double(4997.0)
                                  )
