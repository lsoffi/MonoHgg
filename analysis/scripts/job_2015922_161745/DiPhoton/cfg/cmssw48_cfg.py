...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring('/store/group/phys_higgs/cmshgg/sethzenz/flashgg/RunIISpring15-50ns/Spring15BetaV4/DiPhotonJetsBox_MGG-80toInf_13TeV-Sherpa/RunIISpring15-50ns-Spring15BetaV4-v0-RunIISpring15DR74-Asympt50ns_MCRUN2_74_V9A-v3/150812_180904/0000/myMicroAODOutputFile_73.root')
...
process.TFileService = cms.Service("TFileService",fileName = cms.string("DiPhoton_48.root"))
...
process.diPhoAna = cms.EDAnalyzer('DiPhoAnalyzer',
				  ...
				  bits	        = cms.InputTag('TriggerResults::HLT'),
                                  ...
                                  sumDataset = cms.untracked.double(389.0)
                                  )
