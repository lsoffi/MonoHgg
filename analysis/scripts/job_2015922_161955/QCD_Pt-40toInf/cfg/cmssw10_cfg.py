...
process.TFileService = cms.Service("TFileService",fileName = cms.string("QCD_Pt-40toInf_10.root"))
...
process.diPhoAna = cms.EDAnalyzer('DiPhoAnalyzer',
				  ...
				  bits	        = cms.InputTag('TriggerResults::HLT'),
                                  ...
                                  sumDataset = cms.untracked.double(26915.0)
                                  )
