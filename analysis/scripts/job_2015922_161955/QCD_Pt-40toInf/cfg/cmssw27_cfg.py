...
process.TFileService = cms.Service("TFileService",fileName = cms.string("QCD_Pt-40toInf_27.root"))
...
process.diPhoAna = cms.EDAnalyzer('DiPhoAnalyzer',
				  ...
				  bits	        = cms.InputTag('TriggerResults::HLT'),
                                  ...
                                  sumDataset = cms.untracked.double(3048.0)
                                  )
