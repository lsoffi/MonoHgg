...
process.TFileService = cms.Service("TFileService",fileName = cms.string("QCD_Pt-40toInf_33.root"))
...
process.diPhoAna = cms.EDAnalyzer('DiPhoAnalyzer',
				  ...
				  bits	        = cms.InputTag('TriggerResults::HLT'),
                                  ...
                                  sumDataset = cms.untracked.double(49924.0)
                                  )
