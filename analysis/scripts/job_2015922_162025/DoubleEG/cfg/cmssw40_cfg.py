...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring('/store/group/phys_higgs/cmshgg/sethzenz/flashgg/RunIISpring15-50ns/Spring15BetaV4/DoubleEG/RunIISpring15-50ns-Spring15BetaV4-v0-Run2015B-PromptReco-v1/150812_180939/0000/myMicroAODOutputFile_10.root')
...
process.TFileService = cms.Service("TFileService",fileName = cms.string("DoubleEG_40.root"))
...
process.diPhoAna = cms.EDAnalyzer('DiPhoAnalyzer',
				  ...
				  bits	        = cms.InputTag('TriggerResults::HLT'),
                                  ...
                                  sumDataset = cms.untracked.double(0.0)
                                  )
