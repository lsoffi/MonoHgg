...
process.TFileService = cms.Service("TFileService",fileName = cms.string("GJet_Pt-40toInf_33.root"))
...
process.diPhoAna = cms.EDAnalyzer('DiPhoAnalyzer',
				  ...
				  bits	        = cms.InputTag('TriggerResults::HLT'),
                                  ...
                                  sumDataset = cms.untracked.double(21236.0)
                                  )
