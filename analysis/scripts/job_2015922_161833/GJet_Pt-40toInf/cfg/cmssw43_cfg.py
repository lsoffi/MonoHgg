...
process.TFileService = cms.Service("TFileService",fileName = cms.string("GJet_Pt-40toInf_43.root"))
...
process.diPhoAna = cms.EDAnalyzer('DiPhoAnalyzer',
				  ...
				  bits	        = cms.InputTag('TriggerResults::HLT'),
                                  ...
                                  sumDataset = cms.untracked.double(47247.0)
                                  )
