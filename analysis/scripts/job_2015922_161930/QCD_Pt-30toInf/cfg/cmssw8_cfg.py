...
process.TFileService = cms.Service("TFileService",fileName = cms.string("QCD_Pt-30toInf_8.root"))
...
process.diPhoAna = cms.EDAnalyzer('DiPhoAnalyzer',
				  ...
				  bits	        = cms.InputTag('TriggerResults::HLT'),
                                  ...
                                  sumDataset = cms.untracked.double(3136.0)
                                  )
