...
process.TFileService = cms.Service("TFileService",fileName = cms.string("GJet_Pt-20to40_52.root"))
...
process.diPhoAna = cms.EDAnalyzer('DiPhoAnalyzer',
				  ...
				  bits	        = cms.InputTag('TriggerResults::HLT'),
                                  ...
                                  sumDataset = cms.untracked.double(20896.0)
                                  )
