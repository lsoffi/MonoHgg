...
process.TFileService = cms.Service("TFileService",fileName = cms.string("GJet_Pt-20to40_20.root"))
...
process.diPhoAna = cms.EDAnalyzer('DiPhoAnalyzer',
				  ...
				  bits	        = cms.InputTag('TriggerResults::HLT'),
                                  ...
                                  sumDataset = cms.untracked.double(33531.0)
                                  )
