...
process.TFileService = cms.Service("TFileService",fileName = cms.string("GJet_Pt-20to40_31.root"))
...
process.diPhoAna = cms.EDAnalyzer('DiPhoAnalyzer',
				  ...
				  bits	        = cms.InputTag('TriggerResults::HLT'),
                                  ...
                                  sumDataset = cms.untracked.double(788.0)
                                  )
